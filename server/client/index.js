...
$(document).on('click','#listCohorts li',function(){
  ...
  $.ajax(settings).done(function(r){
    ...
    r.forEach(function(el){
      $("#cContainer").append("<li>"+el.FullName+" <a href='http://34.207.251.58:3000/repo?class="+el.Class+"&user="+el.GithubName+"&repo="+ko+"'>Koans</a>:<div class='"+el.KoansColor+"'>"+el.Koans+"</div> Recursion:<div class='"+el.RecursionColor+"'>"+el.Recursion+"</div> Underbar:<div class='"+el.UnderbarColor+"'>"+el.UnderbarOne+"</div></li>")
    })
  })
})
