...
$(document).on('click','#listCohorts li',function(){
  ...
  $.ajax(settings).done(function(r){
    ...
    r.forEach(function(el){
      $("#cContainer").append("<li>"+el.FullName+" <a href='http://34.207.251.58:9000/"+el.Class+"/"+el.GithubName+"/javascript-koans/KoansRunner.html'>Koans</a>:<div class='"+el.KoansColor+"'>"+el.Koans+"</div> <a href='http://34.207.251.58:9000/"+el.Class+"/"+el.GithubName+"/recursion/SpecRunner.html'>Recursion</a>:<div class='"+el.RecursionColor+"'>"+el.Recursion+"</div><a href='http://34.207.251.58:9000/"+el.Class+"/"+el.GithubName+"/underbar/SpecRunner.html'>Underbar</a>:<div class='"+el.UnderbarColor+"'>"+el.UnderbarOne+"</div><a href='http://34.207.251.58:9000/"+el.Class+"/"+el.GithubName+"/twittler/index.html'>Twittler</a></li>")
    })
  })
})
